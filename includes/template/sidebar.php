...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
      ...
      <div class="user-details">
        <div class="media align-items-center user-pointer collapsed" data-toggle="collapse"
          ...
          <div class="avatar"><img class="mr-3 side-user-img" src="layout/images/avatars/amr.jpg"
              alt="user avatar"></div>
          <div class="media-body">
            <h6 class="side-user-name">Amr Mohsen</h6>
          </div>
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          ...
          <ul class="sidebar-submenu">
            <li><a href="index.html"><i class="zmdi zmdi-dot-circle-alt"></i> Home</a></li>
            <li><a href=""><i class="zmdi zmdi-dot-circle-alt"></i>Categories</a>
            </li>
            <li><a href=""><i class="zmdi zmdi-dot-circle-alt"></i> Items</a></li>
            <li><a href=""><i class="zmdi zmdi-dot-circle-alt"></i> Comments</a>
            </li>
            <li><a href=""><i class="zmdi zmdi-dot-circle-alt"></i> statistcs</a>
            </li>
