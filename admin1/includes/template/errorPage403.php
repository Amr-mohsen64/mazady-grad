                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center error-pages">
                            ...
                            <div class="mt-4">
                            <a href="<?php echo 'index.php';?>" class="btn btn-dark btn-round m-1">Go To Home </a>
                            <a href="<?php echo $_SERVER['HTTP_REFERER'];?>" class="btn btn-warning btn-round m-1">Previous Page </a>
                            </div>

                            <div class="mt-4">
                                <p class="">Copyright © 2012 MAZADY | All rights reserved.</p>
                            </div>
                            <hr class="w-50">
                            <div class="mt-2">
